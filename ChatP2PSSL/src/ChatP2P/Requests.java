...
{   
     ...
     */
    public Requests(SSLSocket socket, ArrayList<PeerTable> online, Peer peer)
    {   
        this.socket = socket;
        this.online = online;
        this.peer = peer;
     ...
     */
    private String getMessage(SSLSocket socket) throws IOException
    {   
        byte[] recevMessage = new byte[5000];
        DataInputStream dis = new DataInputStream(socket.getInputStream());

        int recevMessageSize = dis.read(recevMessage, 0, recevMessage.length);
